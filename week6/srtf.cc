...
int main()
{
    ...
    while (completed != x)
    {
        int idx = -1;
        int mn = 10000000;
        // chọn ra các tiến trình chưa hoàn thành và đã có mặt ở hàng đợi.
        // trong số các tiến trình đó thì chọn tiến trình có thời gian bùng nổ nhỏ nhất, nếu bằng nhau chọn cái đến sớm hơn.
        // nếu chọn được tiến trình thì bắt đầu thực hiện nếu không tăng 
        for (int i = 0; i < x; i++)
        {
